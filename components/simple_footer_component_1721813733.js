...
*/
Vue.component("simple_footer_component_1721813733", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-purple-500 to-purple-700">
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your fan community's potential with FanBuilder. Connect, engage, and grow like never before.
                    </div>
                </div>
            </div>
        </footer> 
